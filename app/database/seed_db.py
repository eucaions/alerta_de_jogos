...
def rodar_seeder():
    ...
    for x in grupos_de_ligas:
        logger.info(f"🚀Populando database a partir da liga {x}")
        
        oficialSeed(x)
        
        logger.info(f"Seed finalizado. Aguardando {INTERVALO_SEGUNDOS} segundos para o próxima liga...")
